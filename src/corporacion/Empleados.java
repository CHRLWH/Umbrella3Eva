...
public class Empleados implements ParaEmpleado {
    ...
    public void subirSueldoEmpleado(double porcentaje) throws JefeBajaSueldosException {
        if (porcentaje < 0) throw new JefeBajaSueldosException("[!] No puedes bajar el salario");
